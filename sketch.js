...
function preload(){
  ...
  trexIMG = loadImage("images/dino.png")
...
function setup() {
 ...
 // gameOver.scale = 0.5;
  ...
  invisibleGround = createSprite(200,displayHeight-190,displayWidth,10);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(displayWidth-100,displayHeight-210,10,40);
    //obstacle.debug = true;
